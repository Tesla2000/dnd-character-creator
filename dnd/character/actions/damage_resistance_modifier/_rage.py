...
from dnd.character.actions.damage_resistance_modifier._base import _DamageResistanceModifier
from dnd.character.actions.damage_resistance_modifier._type import DamageResistanceModifierType
