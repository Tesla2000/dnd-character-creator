...
class AttackWithDagger(_MeleeAttack[SlotT], Generic[SlotT]):
    name: Literal[AbilityName.ATTACK_WITH_DAGGER] = AbilityName.ATTACK_WITH_DAGGER
    ...
    def _ability(cls) -> AbilityName:
        return AbilityName.ATTACK_WITH_DAGGER

    @classmethod
    def _weapon(cls) -> WeaponName:
        return WeaponName.DAGGER
