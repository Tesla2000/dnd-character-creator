...
class AttackWithRapier(_MeleeAttack[SlotT], Generic[SlotT]):
    name: Literal[AbilityName.ATTACK_WITH_RAPIER] = AbilityName.ATTACK_WITH_RAPIER
    ...
    def _ability(cls) -> AbilityName:
        return AbilityName.ATTACK_WITH_RAPIER

    @classmethod
    def _weapon(cls) -> WeaponName:
        return WeaponName.RAPIER
