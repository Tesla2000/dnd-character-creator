...
class AttackWithBrownBearClaw(_BeastMeleeAttack[SlotT], Generic[SlotT]):
    name: Literal[AbilityName.ATTACK_WITH_BROWN_BEAR_CLAW] = (
        AbilityName.ATTACK_WITH_BROWN_BEAR_CLAW
    )

    @classmethod
    def _ability(cls) -> AbilityName:
        return AbilityName.ATTACK_WITH_BROWN_BEAR_CLAW
