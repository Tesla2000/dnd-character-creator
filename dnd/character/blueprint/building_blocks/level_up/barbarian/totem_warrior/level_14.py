...
class BarbarianLevel14TotemWarrior(
    ...
    def _update_blueprint(self, blueprint: _BPT) -> _BPT:
        totem = self.attunement_resolver.resolve()
        attunement_description = self._attunement_description(totem)
            ...
            update={
                ...
                + (
                    BasicAction(
                        ...
                        name=f"Totemic Attunement ({totem.name.title()})",
                        description=attunement_description,
                    ),
                ),
            }
        )
