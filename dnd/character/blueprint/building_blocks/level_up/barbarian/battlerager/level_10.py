...
class BarbarianLevel10Battlerager(
    ...
    """Grants Battlerager level 10 subclass feature."""

    type: Literal[BuildingBlockType.BARBARIAN_LEVEL_10_BATTLERAGER] = (
        BuildingBlockType.BARBARIAN_LEVEL_10_BATTLERAGER
    )
