...
class SorcererLevel14DivineSoul(
    SorcererSubclassFeatureLevelBase[
    ...
    """Increments sorcerer to level 14 and grants Divine Soul origin feature."""

    type: Literal[BuildingBlockType.SORCERER_LEVEL_14_DIVINE_SOUL] = (
        BuildingBlockType.SORCERER_LEVEL_14_DIVINE_SOUL
    )
            ...
            update={
                ...
                + (
                    BasicAction(
                        ...
                        description=(
                            "Grow a pair of magical wings granting a fly speed of 30 feet "
