...
class SorcererLevel1DivineSoul(
    SorcererLevel1Base[Literal[SorcererSubclass.DIVINE_SOUL]]
):
    """Increments sorcerer to level 1 and assigns Divine Soul origin."""

    type: Literal[BuildingBlockType.SORCERER_LEVEL_1_DIVINE_SOUL] = (
        BuildingBlockType.SORCERER_LEVEL_1_DIVINE_SOUL
    )
            ...
            update={
                ...
                + (
                    BasicAction(
                        ...
                        description=(
                            "When you fail a saving throw or miss with an attack roll, "
                            "you can roll 2d4 and add it to the total, possibly changing "
                            "the outcome. You can use this feature once per short rest."
                        ),
                    ),
                ),
            }
