...
class SorcererLevel1ShadowMagic(
    SorcererLevel1Base[Literal[SorcererSubclass.SHADOW_MAGIC]]
):
    """Increments sorcerer to level 1 and assigns Shadow Magic origin."""
    ...
    def _update_blueprint(self, blueprint: _BPT) -> _BPT:
        ...
        update: dict[str, object] = {
            ...
            "actions": blueprint.actions + (AbilityName.STRENGTH_OF_THE_GRAVE,),
        }
        if is_first_class:
