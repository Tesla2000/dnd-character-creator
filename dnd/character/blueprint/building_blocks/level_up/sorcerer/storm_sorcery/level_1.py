...
class SorcererLevel1StormSorcery(
    SorcererLevel1Base[Literal[SorcererSubclass.STORM_SORCERY]]
):
    """Increments sorcerer to level 1 and assigns Storm Sorcery origin."""

    type: Literal[BuildingBlockType.SORCERER_LEVEL_1_STORM_SORCERY] = (
        BuildingBlockType.SORCERER_LEVEL_1_STORM_SORCERY
    )
    ...
    def _update_blueprint(self, blueprint: _BPT) -> _BPT:
        return blueprint.model_copy(
            update={
                ...
                # TODO: add Storm Sorcery level-1 origin feature
            }
        )
