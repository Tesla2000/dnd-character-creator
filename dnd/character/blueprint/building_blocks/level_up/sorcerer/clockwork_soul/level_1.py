...
class SorcererLevel1ClockworkSoul(
    SorcererLevel1Base[Literal[SorcererSubclass.CLOCKWORK_SOUL]]
):
    """Increments sorcerer to level 1 and assigns Clockwork Soul origin."""

    type: Literal[BuildingBlockType.SORCERER_LEVEL_1_CLOCKWORK_SOUL] = (
        BuildingBlockType.SORCERER_LEVEL_1_CLOCKWORK_SOUL
    )
        ...
        update: dict[str, object] = {
            ...
            + (
                BasicAction(
                    ...
                    description=(
                        "When a creature within 60 feet rolls with advantage or "
                        "disadvantage, you can cancel that advantage or disadvantage. "
