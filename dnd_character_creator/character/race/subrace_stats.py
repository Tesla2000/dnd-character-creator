...
class SubraceStats(BaseModel):
    ...
    def apply(self, blueprint: Blueprint) -> Blueprint:
        ...
        return Blueprint(
            ...
            languages=blueprint.languages.union(self.languages),
            skill_proficiencies=blueprint.skill_proficiencies.union(
                self.obligatory_skills
            ),
            tool_proficiencies=blueprint.tool_proficiencies.union(
